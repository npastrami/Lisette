    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      SliderFrame,
      {
        ...
        onResponderGrant: (0, import_core.composeEventHandlers)(props.onResponderGrant, (event) => {
          ...
          import_core.isWeb && target instanceof HTMLElement && context.thumbs.has(target) && target.focus(), !import_core.isWeb && isStartingOnThumb && (context.valueIndexToChangeRef.current = thumbIndex), onSlideStart(event, isStartingOnThumb ? "thumb" : "track");
        }),
