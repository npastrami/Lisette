...
var import_compose_refs = require("@tamagui/compose-refs"), import_core = require("@tamagui/core"), import_remove_scroll = require("@tamagui/remove-scroll"), import_react = require("react"), import_react_native = require("react-native-web"), import_constants = require("./constants"), import_nativeSheet = require("./nativeSheet"), import_SheetContext = require("./SheetContext"), import_SheetImplementationCustom = require("./SheetImplementationCustom"), import_SheetScrollView = require("./SheetScrollView"), import_useSheetController = require("./useSheetController"), import_useSheetOffscreenSize = require("./useSheetOffscreenSize"), import_jsx_runtime = (
  // @ts-ignore
