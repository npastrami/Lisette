...
var import_constants = require("@tamagui/constants"), import_helpers = require("@tamagui/helpers"), import_config = require("../config"), import_isDevTools = require("../constants/isDevTools"), import_createVariable = require("../createVariable"), import_expandStyle = require("./expandStyle"), import_expandStylesAndRemoveNullishValues = require("./expandStylesAndRemoveNullishValues"), import_getVariantExtras = require("./getVariantExtras"), import_isObj = require("./isObj"), import_pseudoDescriptors = require("./pseudoDescriptors");
const propMapper = (key, value, styleStateIn, subPropsIn) => {
  ...
  if (variantValue) {
    const expanded = (0, import_expandStylesAndRemoveNullishValues.expandStylesAndRemoveNullishValues)(
      variantValue,
