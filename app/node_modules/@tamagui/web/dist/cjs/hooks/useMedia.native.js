...
function useMedia(uid, componentContext) {
  const internal = (0, import_react.useRef)(), initialState = ((componentContext ? (0, import_useDisableSSR.getDisableSSR)(componentContext) : (0, import_useDisableSSR.useDisableSSR)()) || !import_constants.isWeb ? mediaState : initState) || {}, state = (0, import_react.useSyncExternalStore)(
    subscribe,
    () => {
      if (!internal.current)
        return initialState;
