...
If this is intended and you are using Tamagui without any themes, you can disable this warning by setting the environment variable TAMAGUI_DISABLE_NO_THEME_WARNING=1`
  ...
  const themeProxied = (0, import_react.useMemo)(() => !themeManager || !(state != null && state.theme) ? {} : getThemeProxied(state, props.deopt, themeManager, keys.current, props.debug), [state == null ? void 0 : state.theme, themeManager, props.deopt, props.debug]);
...
const activeThemeManagers = /* @__PURE__ */ new Set(), useChangeThemeEffect = (props, isRoot = !1, keys, shouldUpdate) => {
  ...
  if (import_constants.isServer || ((0, import_react.useEffect)(() => {
    ...
    const selfListenerDispose = themeManager.onChangeTheme((_a, _b, forced) => {
      ...
      (name, manager, forced) => {
        const force = forced || (shouldUpdate == null ? void 0 : shouldUpdate()) || props.deopt || props["disable-child-theme"], shouldTryUpdate = force ?? !!(keys != null && keys.length || isNewTheme);
  ...
  function createState(prev, force = !1) {
    ...
    if ((0, import_ThemeManager.getHasThemeUpdatingProps)(props)) {
      ...
      if (prev != null && prev.themeManager) {
        ...
        const forceChange = force || !!(keys != null && keys.length), next = themeManager2.getState(props, parentManager), nextState = getShouldUpdateTheme(
          themeManager2,
          next,
          prev.state,
          forceChange
