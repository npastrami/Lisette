            ...
            if (!(val == null || key in usedKeys)) {
              ...
              if (isPseudo) {
                ...
                if (shouldDoClasses && !isEnter && !isExit) {
                  ...
                  import_constants.isWeb && !import_constants.isClient && isEnter && (isDisabled = !1);
  ...
  "../web/dist/cjs/createComponent.native.js"(exports, module2) {
    ...
    function createComponent2(staticConfig) {
      ...
      let {
        ...
        let componentClassName = props.asChild ? "" : props.componentName ? `is_${props.componentName}` : defaultComponentClassName, hasTextAncestor = !!(import_constants.isWeb && isText && componentContext.inText), isDisabled = props.disabled ?? ((_c = props.accessibilityState) == null ? void 0 : _c.disabled), element = import_constants.isWeb && (!Component || typeof Component == "string") && props.tag || Component, BaseTextComponent = BaseText || element || "span", BaseViewComponent = BaseView || element || (hasTextAncestor ? "span" : "div");
        ...
        willBeAnimated && presence && ResetPresence && (content = /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ResetPresence, { children: content })), asChild && (elementType = import_Slot.Slot, Object.assign(viewProps, { onPress, onLongPress }));
        ...
        process.env.TAMAGUI_DOES_SSR_CSS !== "mutates-themes") {
          ...
          for (let key in tokens)
            for (let skey in tokens[key]) {
              ...
              specificTokens[`$${key}.${skey}`] = variable, import_constants.isWeb && ((0, import_registerCSSVariable.registerCSSVariable)(variable), declarations.push((0, import_registerCSSVariable.variableToCSS)(variable, key === "zIndex")));
            }
...
var require_AnimatePresence_native = __commonJS({
  "../animate-presence/dist/cjs/AnimatePresence.native.js"(exports, module2) {
    ...
    var import_use_force_update = require_index_native(), import_web = require_index_native9(), import_react2 = __toESM2(require("react")), import_LayoutGroupContext = require_LayoutGroupContext_native(), import_PresenceChild = require_PresenceChild_native(), import_jsx_runtime6 = require("react/jsx-runtime"), getChildKey = (child) => child.key || "", isDev = !0;
...
var require_index_native20 = __commonJS({
  "../get-font-sized/dist/cjs/index.native.js"(exports, module2) {
    ...
    var import_core13 = require_index_native15(), getFontSized2 = (sizeTokenIn = "$true", { font, fontFamily, props }) => {
      ...
      if (!font)
        return;
      let sizeToken = sizeTokenIn === "$true" ? getDefaultSizeToken(font) : sizeTokenIn, fontSize = font.size[sizeToken], lineHeight = (_a = font.lineHeight) == null ? void 0 : _a[sizeToken], fontWeight = (_b = font.weight) == null ? void 0 : _b[sizeToken], letterSpacing = (_c = font.letterSpacing) == null ? void 0 : _c[sizeToken], textTransform = (_d = font.transform) == null ? void 0 : _d[sizeToken], fontStyle = props.fontStyle ?? ((_e = font.style) == null ? void 0 : _e[sizeToken]);
      return {
  ...
  "../image/dist/cjs/Image.native.js"(exports, module2) {
    ...
    var import_core13 = require_index_native15(), import_react2 = require("react"), import_react_native4 = require("react-native"), import_jsx_runtime6 = require("react/jsx-runtime"), StyledImage = (0, import_core13.styled)(import_react_native4.Image, {
      ...
      (0, import_react2.forwardRef)((inProps, ref) => {
        let [props, style] = (0, import_core13.usePropsAndStyle)(inProps), { src, source, ...rest } = props, finalSource = typeof src == "string" ? { uri: src, ...import_core13.isWeb && { width: props.width, height: props.height } } : source ?? src;
...
var require_registerFocusable_native = __commonJS({
  "../focusable/dist/cjs/registerFocusable.native.js"(exports, module2) {
    ...
    var InputsMap = /* @__PURE__ */ new Map(), registerFocusable = (id, input) => (InputsMap.set(id, input), () => {
      InputsMap.delete(id);
    }), unregisterFocusable = (id) => {
      InputsMap.delete(id);
    }, focusFocusable = (id, select = !1) => {
      let input = InputsMap.get(id);
      input && (select || !input.focusAndSelect ? input.focus() : input.focusAndSelect());
    };
  }
});
...
var require_index_native49 = __commonJS({
  "../../node_modules/use-sync-external-store/shim/index.native.js"(exports, module2) {
    "use strict";
    module2.exports = require_use_sync_external_store_shim_native_development();
  }
});
...
function useStore(api, selector = api.getState, equalityFn) {
  equalityFn && !didWarnAboutEqualityFn && (console.warn(
...
var import_react, import_with_selector, useSyncExternalStoreWithSelector, didWarnAboutEqualityFn, createImpl, create, react, init_esm = __esm({
  "../../node_modules/reforest/node_modules/zustand/esm/index.js"() {
    ...
    createImpl = (createState) => {
      typeof createState != "function" && console.warn(
    ...
    }, create = (createState) => createState ? createImpl(createState) : createImpl, react = (createState) => (console.warn(
...
var require_SelectImpl_native = __commonJS({
  "../select/dist/cjs/SelectImpl.native.js"(exports, module2) {
    ...
    var import_jsx_runtime6 = require("react/jsx-runtime"), SelectInlineImpl = (props) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_jsx_runtime6.Fragment, { children: props.children });
  }
});
...
var require_Tabs_native = __commonJS({
  "../tabs/dist/cjs/Tabs.native.js"(exports, module2) {
    ...
    ), Tabs = (0, import_web.withStaticProperties)(TabsComponent, {
      List: TabsList,
      /**
  ...
  "../theme/dist/cjs/_mutateTheme.native.js"(exports, module2) {
    ...
    function _mutateTheme(props) {
      if (import_constants.isServer)
        return;
      let config = (0, import_web.getConfig)(), { name: themeName, theme: themeIn, insertCSS, mutationType } = props, theme = {
...
var import_core = __toESM(require_index_native15()), createTamagui = import_core.createTamagui;
